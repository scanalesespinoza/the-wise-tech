...
---
## Propósito
Enmarca cómo Editorial-Workflow — Propuesta→Draft→Review→Publish ayuda a mantener decisiones alineadas con The Wise Tech.

## Audiencia
Personas y equipos que necesitan una guía rápida sobre Editorial-Workflow — Propuesta→Draft→Review→Publish.

## Cuándo usarlo
Consúltalo cuando requieras referencias inmediatas para Editorial-Workflow — Propuesta→Draft→Review→Publish o debas compartir el enfoque con otros equipos.

> **Propósito:** Dar contexto accionable sobre Editorial-Workflow — Propuesta→Draft→Review→Publish dentro de The Wise Tech.
> **Audiencia:** Equipos y perfiles interesados en las bases de conocimiento y lineamientos del programa.
> **Uso recomendado:** Consulta este documento cuando necesites aplicar o compartir detalles de Editorial-Workflow — Propuesta→Draft→Review→Publish.
> **Estado:** Activo.
...
- [Definition-of-Done-mínimo](#definition-of-done-mnimo)
- [Automatización-y-CI](#automatizacin-y-ci)
- [Versionado-y-seguimiento](#versionado-y-seguimiento)
- [See-also](#see-also)
