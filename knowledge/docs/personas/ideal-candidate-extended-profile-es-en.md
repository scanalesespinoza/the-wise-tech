...
- Valora la **resiliencia observable** (systems/tests/CI, paridad, SLOs) y el **feedback humano**.
...
- Values **observable resilience** (systems/tests/CI, parity, SLOs) and **human feedback**.
...
- Long docs without examples; ignoring signals (failing systems/tests/parity).
