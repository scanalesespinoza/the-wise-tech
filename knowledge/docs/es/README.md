> **Propósito:** Dar contexto accionable sobre The Wise Tech · Puente en español dentro de The Wise Tech.
> **Audiencia:** Equipos y perfiles interesados en las bases de conocimiento y lineamientos del programa.
> **Uso recomendado:** Consulta este documento cuando necesites aplicar o compartir detalles de The Wise Tech · Puente en español.
> **Estado:** Activo.
...
Esta carpeta conserva un resumen en español para quienes guardaron la estructura
bilingüe anterior y necesitan atajos hacia el nuevo árbol de documentación.

## Navegación rápida
- [Principios](../principles/wise-tech-principles.md)
- [Rutas por rol](../personas/_index.md)
