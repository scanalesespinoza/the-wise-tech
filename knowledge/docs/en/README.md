...
This folder keeps a concise English digest for contributors who bookmarked the
former bilingual structure and want pointers to the refreshed documentation tree.

## Quick navigation
- [Principles overview](../principles/wise-tech-principles.md)
- [Role journeys](../personas/_index.md)
