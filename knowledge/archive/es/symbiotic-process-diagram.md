...
|   |                                                               |        |
|   |   - Requerimientos de desarrollo  <--->  Feedback en runtime  |        |
|   |                                                               |        |
|   +---------------------------------------------------------------+        |
|                          |                     |                           |
|                          |                     |                           |
...
|   |                                                               |        |
|   |   - Estabilidad operativa  <--->  Requerimientos de soporte   |        |
|   |                                                               |        |
|   +---------------------------------------------------------------+        |
|                          ^                     ^                           |
|                          |                     |                           |
|                          +---------------------+                           |
|                       Bucle de feedback simbiótico                          |
|                                                                            |
|   +---------------------------------------------------------------+        |
|   |                Bucle de feedback de personas usuarias         |        |
|   |   - Experiencia de usuario  <--->  Mejora del producto        |        |
|   +---------------------------------------------------------------+        |
+----------------------------------------------------------------------------+
```
