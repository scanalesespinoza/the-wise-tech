...
- Documenta en la PR por qué el contenido pasa a `archive/` y qué lo reemplaza.
- Añade una nota en `docs/audit/content-audit.md` para dejar rastro del movimiento.
