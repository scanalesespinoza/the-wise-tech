...
| --- | --- | --- |
| Consumers 30/60/90 | Hero con testimonios y contador de historias activas. | [🍃 Ver índice de valor](es/guides/choose-your-path.md) |
| Developers 30/60/90 | Tablero tipo Kanban (Docs, Código, Feedback). | [⚡ Ver índice de valor](es/guides/choose-your-path.md) |
| Platform Engineers 30/60/90 | Matriz de controles (Políticas, SLOs, Runbooks). | [🛡️ Ver índice de valor](es/guides/choose-your-path.md) |
