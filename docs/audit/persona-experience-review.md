...
8. **CLI prescriptivo.** Actualizar `scripts/check-error-budget.py` para imprimir acciones recomendadas inmediatas.
...
| Benjamín | Ejecutar `make ci` y abrir PR “PR Ideas #1” | ✅ PR mergeado con pequeño cambio en doc/test |
| Camila | Añadir 1 test de contrato y verlo en CI | ✅ `make test` y workflow pasan |
