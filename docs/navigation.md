...
# 🧭 Elige tu camino en The Wise Tech

Conecta cada perfil con la acción correcta en segundos. Usa la vista rápida para decidir si necesitas un recorrido completo (30/60/90) o un atajo fast-track.
...
1. **Identifica tu rol** usando los iconos anteriores.
2. **Elige un botón**: *Fast Track* condensa 3 pasos; la ruta 30/60/90 agrega contexto extendido.
3. **Guarda los enlaces** que necesites en favoritos o doc interno; todos mantienen la misma estructura bilingüe.
